        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex gap-4 pt-6 items-start">
            <Button size="lg" className="" onClick={() => {
              token ? toast({
                title: `Added "${MOCK_BOOK.title.toUpperCase()}" to your cart `,
                description: "Great Choice 👉👈",

              }) :
                toast({
                  title: `Login to Buy "${MOCK_BOOK.title.toUpperCase()} `,
                  description: `${MOCK_BOOK.title.toUpperCase()}" is waiting for you 👉👈 `,
